...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleNotFound(RentalApplicationNotFoundException ex) {
    ...
    public ResponseEntity<Map<String, Object>> handleInvalidStatus(InvalidApplicationStatusException ex) {
    ...
    public ResponseEntity<Map<String, Object>> handleUnauthorized(UnauthorizedRentalActionException ex) {
